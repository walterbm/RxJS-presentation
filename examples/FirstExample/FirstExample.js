...
// stream A will be an event stream with only two events (3 & 4)
var streamA = Rx.Observable.of(3, 4);
// stream B will map over every event from A and perform an operation
var streamB = streamA.map(a => 10 * a);
// let's listen to A to see all the A events
console.log("Events from stream A:");
streamA.subscribe(a => console.log(a)); // => 3; 4;
// let's listen to B to see how the changing value of A events affect the B events
